...
const availableCategories = [
  Category(
    id: 'c1',
    title: 'Italian',
    color: Color.fromARGB(255, 110, 18, 126),
  ...
  Category(
    id: 'c3',
    title: 'Hamburgers',
    color: Color.fromARGB(255, 184, 38, 28),
    image: 'assets/images/hamburger.jpg',
  ),
  Category(
    id: 'c4',
    title: 'German',
    color: Color.fromARGB(255, 25, 77, 27),
  ...
  Category(
    ...
    title: 'Light & Lovely',
    color: Colors.orange,
    image: 'assets/images/Wiener.jpg',
  ),
  Category(
    id: 'c6',
    title: 'Exotic',
    color: Color.fromARGB(255, 204, 19, 80),
    image: 'assets/images/exotic.jpg',
  ),
  Category(
    id: 'c7',
    title: 'Breakfast',
    color: Color.fromARGB(255, 222, 204, 43),
    image: 'assets/images/pancakes.jpg',
  ),
  Category(
    id: 'c8',
    title: 'Asian',
    color: Color.fromARGB(255, 82, 51, 39),
    image: 'assets/images/asian.jpg',
  ),
  Category(
    id: 'c9',
    title: 'French',
    color: Color.fromARGB(255, 5, 110, 100),
  ...
  Category(
    id: 'c11',
    title: 'Desserts',
    color: Color.fromARGB(255, 5, 9, 112),
...
const dummyMeals = [
  ...
  Meal(
    ...
    steps: [
      'Preheat oven to 175°C. Grease and flour two 9-inch round baking pans.',
  ...
  Meal(
    ...
    steps: [
      ...
      'Apply BBQ rub generously to both sides of ribs.',
      'Wrap ribs in plastic wrap and refrigerate for 4-8 hours.',
      'Preheat oven to 225°F (107°C).',
      'Place ribs bone-side down on baking sheet, cover with foil.',
      'Bake for 2.5-3 hours until tender.',
      'Mix BBQ sauce with vinegar, brown sugar, Worcestershire, and liquid smoke.',
      'Remove ribs from oven, brush with sauce.',
      'Grill over medium heat for 10-15 minutes, basting with sauce.',
